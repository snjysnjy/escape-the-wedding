...
import Animated, { FadeIn, FadeInUp, useAnimatedStyle, withTiming, withRepeat, withSequence } from 'react-native-reanimated';
...
const { timeLeft, targetDate } = useCountdown(extensionDays, baseTargetDate); // Assuming useCountdown takes baseDate
